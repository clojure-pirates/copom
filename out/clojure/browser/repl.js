...
var seq__60725_60729 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__60726_60730 = null;
var count__60727_60731 = (0);
var i__60728_60732 = (0);
while(true){
if((i__60728_60732 < count__60727_60731)){
var str_60733 = cljs.core._nth.call(null,chunk__60726_60730,i__60728_60732);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_60733})));


var G__60734 = seq__60725_60729;
var G__60735 = chunk__60726_60730;
var G__60736 = count__60727_60731;
var G__60737 = (i__60728_60732 + (1));
seq__60725_60729 = G__60734;
chunk__60726_60730 = G__60735;
count__60727_60731 = G__60736;
i__60728_60732 = G__60737;
continue;
} else {
var temp__5735__auto___60738 = cljs.core.seq.call(null,seq__60725_60729);
if(temp__5735__auto___60738){
var seq__60725_60739__$1 = temp__5735__auto___60738;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__60725_60739__$1)){
var c__4550__auto___60740 = cljs.core.chunk_first.call(null,seq__60725_60739__$1);
var G__60741 = cljs.core.chunk_rest.call(null,seq__60725_60739__$1);
var G__60742 = c__4550__auto___60740;
var G__60743 = cljs.core.count.call(null,c__4550__auto___60740);
var G__60744 = (0);
seq__60725_60729 = G__60741;
chunk__60726_60730 = G__60742;
count__60727_60731 = G__60743;
i__60728_60732 = G__60744;
continue;
} else {
var str_60745 = cljs.core.first.call(null,seq__60725_60739__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_60745})));


var G__60746 = cljs.core.next.call(null,seq__60725_60739__$1);
var G__60747 = null;
var G__60748 = (0);
var G__60749 = (0);
seq__60725_60729 = G__60746;
chunk__60726_60730 = G__60747;
count__60727_60731 = G__60748;
i__60728_60732 = G__60749;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__60754 = script;
goog.object.set(G__60754,"type","text/javascript");

goog.object.set(G__60754,"onload",onload);

goog.object.set(G__60754,"onreadystatechange",onload);

return G__60754;
})();
if((opt_sourceText == null)){
var G__60755 = script__$1;
goog.object.set(G__60755,"src",src);

return G__60755;
} else {
var G__60756 = script__$1;
goog.dom.setTextContext(G__60756,opt_sourceText);
...
var path_60757 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_60757);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_60757)].join(''));
} else {
var path_60758 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_60758);

goog.object.remove(goog.dependencies_.written,path_60758);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_60758)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__60759 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__60760 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__60760;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__60759;
}})()})));
});})(connected_QMARK_,repl_connection))
);
